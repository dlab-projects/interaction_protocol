"""Plot synchronous Llama 3.1 8B debate outcomes for Figure 20."""
...
OUTPUT_PATH = REPO_ROOT / "artifacts" / "figures" / "appF_llama8b_sync.pdf"

DATA_PATHS = (
    DATA_DIR / "sync_h2h_gpt_vs_llama8b.parquet",
    DATA_DIR / "sync_h2h_cla_vs_llama8b.parquet",
    DATA_DIR / "sync_h2h_gem_vs_llama8b.parquet",
)
COMPARISON_MODELS = ("GPT-4.1", "Claude 3.7 Sonnet", "Gemini 2.0 Flash")
FOCAL_MODEL = "Llama-8b"
...
def build_figure(dataframes: tuple[pd.DataFrame, ...]) -> plt.Figure:
    """Build the two-panel Llama 3.1 8B figure."""
...
def main() -> None:
    """Load Llama 3.1 8B data, build Figure 20, and save it."""
    use_latex_style()
